...
namespace RentalKendaraan.Controllers
{
    public class JenisKendaraansController : Controller
    {
        ...
        public async Task<IActionResult> Index(string ktsd, string sortOrder, string searchString, string currentFilter, int? pageNumber)
        {
            ...
            {
                menu = menu.Where(x => x.IdJenisKendaraan.ToString() == ktsd);
            }
            ...
            switch (sortOrder)
            {
                case "name_desc":
                    ...
                    break;
                case "Date":
                    menu = menu.OrderBy(s => s.IdJenisKendaraan.ToString());
                    break;
                case "date_desc":
                    menu = menu.OrderByDescending(s => s.IdJenisKendaraan.ToString());
                    break;
